      ...
      <section class=" p-5  ">
        <div class="content text-white h-screen ">
          <div class="content__text py-20">
            ...
            <h5 class="hero__text py-5" data-aos="fade-up">
              Music NFTs will continue to revolutionize the way that artists and
              fans create community <br />
              together as we enter the upcoming year — undoubtedly changing the
              trajectory of <br /> countless budding music careers.
            </h5>
          </div>
        ...
        <Marquee duration={10000}>
          <div class="text-white uppercase font-light text-2xl flex space-x-4 ">
            ...
            >
              ...
              />
              <path
                d="M18 3C21.7519 7.10753 23.8841 12.4381 24 18C23.8841 23.5619 21.7519 28.8925 18 33C14.2481 28.8925 12.1159 23.5619 12 18C12.1159 12.4381 14.2481 7.10753 18 3V3Z"
                stroke="white"
                stroke-linecap="round"
                stroke-linejoin="round"
              />
